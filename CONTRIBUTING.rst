...
If you would like to contribute to Consumer API Example, please take a look at the
`current issues <https://github.com/sergeyklay/consumer-pact-example/issues>`_.
...
2. Fork `the repository <https://github.com/sergeyklay/consumer-pact-example>`_
